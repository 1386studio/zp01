...
router.get('/', function(req, res, next) {
  axios
	...
	.then(axios.spread((res1,res2,res3,res4,res5)=>{
		res.render('index', { title: '首页' ,breadcrumb:[],toparticles:res1.data,miltoparticles:res2.data,pictoparticles:res3.data,wxtoparticles:res4.data,topwebsites:res5.data});
	}))
});
